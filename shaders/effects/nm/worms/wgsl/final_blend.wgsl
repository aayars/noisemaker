...
fn main(@builtin(global_invocation_id) gid : vec3<u32>) {
    ...
    output_buffer[base + 0u] = clamp_01(trail_color.x);
    output_buffer[base + 1u] = clamp_01(trail_color.y);
    output_buffer[base + 2u] = clamp_01(trail_color.z);
    output_buffer[base + 3u] = clamp_01(trail_color.w);
}
