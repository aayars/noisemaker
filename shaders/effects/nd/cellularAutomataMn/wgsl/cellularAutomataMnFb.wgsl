...
fn main(@builtin(position) fragCoord: vec4<f32>) -> @location(0) vec4<f32> {
    ...
    // Slot 0: time, deltaTime, frame
    let deltaTime: f32 = uniforms.data[0].y;
    // Slot 1: speed, weight, seed, resetState
    let speed: f32 = uniforms.data[1].x;
    let weight: f32 = uniforms.data[1].y;
    let seed: f32 = uniforms.data[1].z;
    let resetState: bool = uniforms.data[1].w > 0.5;
    // Slot 2: n1v1, n1r1, n1v2, n1r2
    let n1v1: f32 = uniforms.data[2].x;
    let n1r1: f32 = uniforms.data[2].y;
    let n1v2: f32 = uniforms.data[2].z;
    let n1r2: f32 = uniforms.data[2].w;
    // Slot 3: n1v3, n1r3, n1v4, n1r4
    let n1v3: f32 = uniforms.data[3].x;
    let n1r3: f32 = uniforms.data[3].y;
    let n1v4: f32 = uniforms.data[3].z;
    let n1r4: f32 = uniforms.data[3].w;
    // Slot 4: n2v1, n2r1, n2v2, n2r2
    let n2v1: f32 = uniforms.data[4].x;
    let n2r1: f32 = uniforms.data[4].y;
    let n2v2: f32 = uniforms.data[4].z;
    let n2r2: f32 = uniforms.data[4].w;
