...
export default class CellularAutomataMN extends Effect {
  ...
  passes = [
    {
      name: "update",
      program: "cellularAutomataMnFb",
      inputs: {
        bufTex: "globalCaMnState",
        seedTex: "inputTex"
      },
      outputs: {
        fragColor: "globalCaMnState"
      }
    },
    {
      name: "render",
      program: "cellularAutomataMn",
      inputs: {
        fbTex: "globalCaMnState",
        prevFrameTex: "globalCaMnState",
        bufTex: "globalCaMnState",
        inputTex: "inputTex"
      },
      outputs: {
