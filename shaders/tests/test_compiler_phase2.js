...
`, (result) => {
    ...
    if (plan.chain[0].op !== 'basics.osc') throw new Error('Expected basics.osc first');
    if (plan.chain[1].op !== 'basics.rotate') throw new Error('Expected basics.rotate second');
});
