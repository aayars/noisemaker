...
# -*- coding: utf-8 -*-
#
# Noisemaker documentation build configuration file, created by
# sphinx-quickstart on Mon Mar 27 22:59:57 2017.
#
...
autodoc_typehints = 'signature'  # Show type hints in function signature
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'venv', 'docs-venv']
...
html_theme_options = {
    "light_css_variables": {
        "font-stack": "Nunito, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",
        "font-stack--monospace": "Sono, SFMono-Regular, Consolas, Liberation Mono, Menlo, Monaco, monospace",
    },
    "dark_css_variables": {
        "font-stack": "Nunito, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif",
        "font-stack--monospace": "Sono, SFMono-Regular, Consolas, Liberation Mono, Menlo, Monaco, monospace",
...
man_pages = [
    (master_doc, 'noisemaker', 'Noisemaker Documentation',
     [author], 1)
]
...
class Mock(MagicMock):
    """Mock for unavailable packages that properly formats for type hints."""
    ...
    def __repr__(self):
        return f'{self._mock_name or "Mock"}'
